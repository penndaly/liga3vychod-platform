export const CLUBS_2025_26 = [
  ...
  { id: 3,  name: 'MŠK Tesla Stropkov',      short: 'STR', slug: 'stropkov'          },
  { id: 4,  name: 'OFK SIM Raslavice',       short: 'RAS', slug: 'raslavice'         },
  { id: 5,  name: 'ŠK Odeva Lipany',         short: 'LIP', slug: 'lipany'            },
  { id: 6,  name: 'MFK Spartak Medzev',      short: 'MED', slug: 'medzev'            },
  { id: 7,  name: 'MFK Snina',               short: 'SNA', slug: 'snina'             },
  { id: 8,  name: 'FC Košice B',             short: 'KSB', slug: 'kosice-b'          },
  { id: 9,  name: '1. MFK Kežmarok',         short: 'KEŽ', slug: 'kezmarok'          },
  { id: 10, name: 'MFK Vranov nad Topľou',   short: 'VNT', slug: 'vranov'            },
  { id: 11, name: 'FK Poprad',               short: 'POP', slug: 'poprad'            },
  { id: 12, name: 'MFK Slovan Sabinov',      short: 'SAB', slug: 'sabinov'           },
  { id: 13, name: 'FC Lokomotíva Košice',    short: 'LOK', slug: 'lokomotiva-kosice' },
