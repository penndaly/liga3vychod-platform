export const CLUBS = [
  { id: 1,  name: 'FK Bardejov',                      short: 'BDJ' },
  { id: 2,  name: 'MFK Vranov nad Topľou',             short: 'VNT' },
  { id: 3,  name: 'TJ Slavoj Trebišov',                short: 'TRB' },
  { id: 4,  name: 'FK Humenné',                        short: 'HMN' },
  { id: 5,  name: 'FK Gelnica',                        short: 'GEL' },
  { id: 6,  name: 'TJ Partizán Bardejovská Nová Ves',  short: 'PBV' },
  { id: 7,  name: 'FC Košice B',                       short: 'KSB' },
  { id: 8,  name: 'FK Sabinov',                        short: 'SAB' },
  { id: 9,  name: 'TJ Spišská Nová Ves',               short: 'SNV' },
  { id: 10, name: 'TJ Sokol Stará Ľubovňa',            short: 'STĽ' },
  { id: 11, name: 'FK Rešov',                          short: 'REŠ' },
  { id: 12, name: 'TJ Čeľovce',                        short: 'ČEĽ' },
  { id: 13, name: 'MFK Michalovce B',                  short: 'MCB' },
  { id: 14, name: 'TJ Dynamo Prešov',                  short: 'DPR' },
]
