...
export const STANDINGS = [
  ...
  { pos: 2, club: 'FK Bardejov',               p: 24, w: 15, d: 4, l: 5, gf: 44, ga: 25, gd: 19, pts: 49, form: ['W','L','W','W','D'] },
  ...
  { pos: 5, club: 'MFK Tatran Liptovský Mikuláš', p: 24, w: 11, d: 5, l: 8, gf: 32, ga: 31, gd: 1, pts: 38, form: ['D','D','W','L','W'] },
]

export const RECENT_MATCHES = [
  { round: 24, home: 'FC Košice B',           homeGoals: 3, awayGoals: 1, away: 'FK Bardejov',          date: '17.05.2026' },
  { round: 24, home: 'MFK Vranov nad Topľou', homeGoals: 2, awayGoals: 0, away: 'FK Poprad',            date: '17.05.2026' },
  { round: 24, home: 'FK Slavoj Trebišov',    homeGoals: 1, awayGoals: 1, away: 'MFK Snina',            date: '17.05.2026' },
]

export const UPCOMING_FIXTURES = [
  { round: 25, home: 'FK Bardejov',           away: 'MFK Vranov nad Topľou',        date: '24.05.2026', time: '16:30' },
  { round: 25, home: 'FC Košice B',           away: 'FK Poprad',                    date: '24.05.2026', time: '16:30' },
  { round: 25, home: 'MFK Stará Ľubovňa',    away: 'MFK Tatran Liptovský Mikuláš', date: '24.05.2026', time: '16:30' },
]
...
export const NEWS = [
  {
    ...
    excerpt: 'FC Košice B potvrdili vedenie v tabuľke víťazstvom 3:1 nad FK Bardejov v 24. kole TIPOS III. Ligy Východ.',
    date: '17.05.2026',
    club: 'FC Košice B',
    category: 'Výsledky',
  },
  {
    ...
    excerpt: 'Najbližšie kolo prinesie zaujímavé stretnutia. Kľúčovým zápasom bude duel Bardejov vs Vranov.',
    date: '20.05.2026',
    club: 'Liga',
    category: 'Program',
  },
...
export const TOP_SCORERS = [
  ...
  { rank: 2, name: 'Tomáš Novák',    club: 'FK Bardejov',                   goals: 15 },
  { rank: 3, name: 'Lukáš Horváth',  club: 'MFK Vranov nad Topľou',         goals: 13 },
  { rank: 4, name: 'Juraj Baláž',    club: 'FK Poprad',                     goals: 11 },
  { rank: 5, name: 'Peter Šimko',    club: 'MFK Tatran Liptovský Mikuláš',  goals:  9 },
]
